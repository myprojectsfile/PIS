...
namespace pis.data.automation.entities
{
    public partial class Entity1
    {
        ...
        public bool? PhysicalYes { get; set; }
        public bool? PhysicalNo { get; set; }
        public bool? VirtualYes { get; set; }
        public bool? VirtualNo { get; set; }
        public string Snapshot { get; set; }
        public string UpdateList { get; set; }
        public string FeforrtRole { get; set; }
        public string FbVerifyRole { get; set; }
        public DateTime? TimeDateSnap { get; set; }
