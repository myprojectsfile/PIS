...
{
    public partial class EntityBankGuarantee
    {
        ...
        public string ForGuarantee { get; set; }
        public string Bank { get; set; }
        public string Branch { get; set; }
        public bool? Worker { get; set; }
        public bool? Employe { get; set; }
        public DateTime? Date { get; set; }
        public bool? Rassmi { get; set; }
        public bool? Contract { get; set; }
        public bool? Peymani { get; set; }
        public bool? Working { get; set; }
        public int? ContractType { get; set; }
        public bool? Retierd { get; set; }
        public bool? Mostamarri { get; set; }
        public string Relation { get; set; }
        public string Max { get; set; }
        public double? MonthlySalary { get; set; }
        public double? VamMax { get; set; }
        public string OfAction { get; set; }
        public string Confimed { get; set; }
        public string OfActionSign { get; set; }
        public string ConfimedSign { get; set; }
