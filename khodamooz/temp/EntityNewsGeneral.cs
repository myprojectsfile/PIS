...
{
    public partial class EntityNewsGeneral
    {
        ...
        public string AttachmentfileOne { get; set; }
        public string AttachmentfileTwo { get; set; }
        public string AttachmentfileThree { get; set; }
        public string Subject { get; set; }
        public DateTime? Date { get; set; }
        public string AttachmentfileFour { get; set; }
        public string AttachmentfileFive { get; set; }
        public string AttachmentfileSix { get; set; }
        public string AttachmentfileSeven { get; set; }
    }
}
