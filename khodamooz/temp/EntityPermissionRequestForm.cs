...
{
    public partial class EntityPermissionRequestForm
    {
        ...
        public bool? ConNetwork { get; set; }
        public bool? ConAutomation { get; set; }
        public string ConSoftware { get; set; }
        public string HerasatSign { get; set; }
    }
}
